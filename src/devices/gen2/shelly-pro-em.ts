...
export class ShellyProEm extends Device {
  static readonly model: string = 'SPEM-002CEBEU50';
  static readonly modelName: string = 'Shelly Pro EM';
...
Device.registerClass(ShellyProEm);
